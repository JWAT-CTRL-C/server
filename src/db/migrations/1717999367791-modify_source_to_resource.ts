...
export class ModifySourceToResource1717999367791 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "resource" DROP CONSTRAINT "PK_98df46d4eddfa1a64983aecc027"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "resource" ADD "resrc_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource" ADD CONSTRAINT "PK_d0f5f0404e9de77fd91d030cf93" PRIMARY KEY ("resrc_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource" ADD "resrc_name" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource" ADD "resrc_url" text NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "resource" DROP CONSTRAINT "PK_d0f5f0404e9de77fd91d030cf93"`,
    );
    await queryRunner.query(`ALTER TABLE "resource" DROP COLUMN "resrc_id"`);
    await queryRunner.query(
      `ALTER TABLE "resource" ADD "src_url" text NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource" ADD "src_name" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource" ADD "src_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "resource" ADD CONSTRAINT "PK_98df46d4eddfa1a64983aecc027" PRIMARY KEY ("src_id")`,
    );
    await queryRunner.query(
